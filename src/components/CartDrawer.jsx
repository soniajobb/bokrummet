        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "8px clamp(16px, 6vw, 30px)" }}>
          {checkoutStep === "done" ? (
            <div style={{ textAlign: "center", margin: "20px 0" }}>
              ...
              <p style={{ margin: "0 0 24px", fontSize: 14, lineHeight: 1.6, color: colors.textSoft3 }}>
              ...
              <div style={{ display: "flex", justifyContent: "center", marginBottom: 16 }}>
                <div style={{ background: "#fff", padding: 12, borderRadius: 12, border: `1px solid ${colors.border1}` }}>
                  <img
                    src={buildSwishQrUrl(orderSummary?.total ?? 0, orderSummary?.swishMessage ?? "Bokrummet")}
                    alt="Swish QR-kod"
              ...
              <div style={{ background: colors.card, border: `1px solid ${colors.border2}`, borderRadius: 10, padding: "14px 16px", textAlign: "left", marginBottom: 14 }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 6 }}>
                  ...
                  <span style={{ fontFamily: fonts.heading, fontWeight: 600, fontSize: 22, color: colors.accent }}>{orderSummary?.total ?? 0} kr</span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 6 }}>
                  <span style={{ fontSize: 13, letterSpacing: ".5px", color: colors.textSoft2 }}>Leverans</span>
                  <span style={{ fontSize: 15, color: colors.textDark }}>{orderSummary?.shipLabel ?? ""}</span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  <span style={{ fontSize: 13, letterSpacing: ".5px", color: colors.textSoft2 }}>Meddelande</span>
                  <span style={{ fontSize: 15, color: colors.textDark, textAlign: "right" }}>{orderSummary?.swishMessage ?? ""}</span>
                </div>
              </div>
              <a
